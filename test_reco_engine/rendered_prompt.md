...
{
  "user_id": "{user_id}",
  "generated_at": "2026-06-29T14:59:28Z",
  "recommendations": [
    {
      "rank": {rank},
      "item_id": "{item_id}",
...
| `generated_at` | ISO 8601 | `2026-06-29T14:59:28Z` — when recommendations were produced |
...
| `2026-06-29T14:59:28Z` | ISO 8601 | Timestamp for the response (optional pre-fill) |
| `| Action | Weight | Meaning |
|--------|--------|----------|
| purchase | 1.0 | Strong positive signal |
| add_to_cart | 0.85 | High intent |
