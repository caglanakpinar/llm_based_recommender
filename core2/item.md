...
- Collaborative filtering features:
	...
	- number of similar users to {target_user} who purchased {item_id} is {num_similar_users_purchased_item}
...
- Final scoring feature:
	- relevance score for {target_user} and {item_id} is {relevance_score}
