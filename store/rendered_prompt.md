...
generate **3** personalized recommendations for user **`user_001`**.
...
|-------|------|-------------|
| `target_user_id` | string | Must match `user_001` from Section 3 |
...
| `user_001` | string | User ID to recommend for |
...
**Your answer:** Recommendations for **`user_001`** as defined in Section 7.
